...
class recipe {
    ...
    init() {
        ...
        this.recipe.insert({
            ...
            category: ("main"),
            ingredients: [{ food_ingredient: "macaroni", food_ingredientquantity: "2 thinly sliced" },
            { food_ingredient: "butter", food_ingredientquantity: "1 tbsp" },
            { food_ingredient: "plain flour", food_ingredientquantity: "1 glass" },
            { food_ingredient: "milk", food_ingredientquantity: "1 tbsp" },
            { food_ingredient: "cheddar, grated", food_ingredientquantity: "1 tbsp" },
